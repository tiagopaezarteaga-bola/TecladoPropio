...
finish()
    ...
    return try {
        ...
        startActivity(Intent.createChooser(shareIntent, "Guardar / compartir diccionario"))
        true
    } catch (e: Exception) {
        e.printStackTrace()
        false
    ...
    try {
        ...
        startActivityForResult(Intent.createChooser(importIntent, "Importar diccionario"))
    } catch (e: Exception) {
        e.printStackTrace()
