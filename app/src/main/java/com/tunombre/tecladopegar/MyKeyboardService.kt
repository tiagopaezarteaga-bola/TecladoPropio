...
class MyKeyboardService : InputMethodService() {
    ...
    override fun onCreateInputView(): View {
        ...
        val keyboardView = KeyboardView(this).apply {
            ...
            onPeriod = { currentInputConnection?.commitText(".", 1) }
            onNumbers123 = { /* pendiente: cambiar a fila de numeros y simbolos */ }
            onEmoji = { /* pendiente: abrir selector de emojis */ }
        }
