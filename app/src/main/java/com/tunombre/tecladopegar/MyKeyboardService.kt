...
class MyKeyboardService : InputMethodService() {
    ...
    override fun onStartInput(attribute: EditorInfo?, restarting: Boolean) {
        ...
        val isSearchField = attribute != null && (
            ...
            (attribute.inputType and android.text.InputType.TYPE_TEXT_VARIATION_WEB_SEARCH) != 0 ||
            (attribute.inputType and android.text.InputType.TYPE_TEXT_VARIATION_FILTER) != 0
        )
