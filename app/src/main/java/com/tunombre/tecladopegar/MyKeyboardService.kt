...
class MyKeyboardService : InputMethodService() {
    ...
    override fun onCreateInputView(): View {
        ...
        keyboardView.onBackspace = {
            val ic = currentInputConnection
            if (ic != null) {
                // El backspace SOLO borra. No toca ninguna variable de contexto.
                // Los bigramas se registran únicamente en los disparadores legítimos:
                // espacio, signo de puntuación, siguiente swipe, tap en sugerencia.
                // Mientras el usuario corrige letra a letra, ninguna de esas condiciones
                // se cumple, así que ningún bigrama espurio se registra.
        ...
        keyboardView.onSwipeSuggestions = { _, pathChars, totalLenPx, durationMs, pauseIndices ->
            ...
            // Es un disparador legítimo: ahora sí se registra el bigrama y la trayectoria.
            if (pendingSwipeWord != null) {
                val confirmedWord = lastSwipeCommittedWord
