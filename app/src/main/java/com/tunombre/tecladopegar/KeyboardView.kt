...
class KeysCanvasView(context: Context) : View(context) {
    ...
    private fun showAccentPopup(key: KeyInfo, variants: List<String>) {
        ...
        // P4: si la tecla está en row1 (top ≈ 0), el popup quedaría fuera de la pantalla
        // hacia arriba. En ese caso lo mostramos DEBAJO de la tecla.
        val popupYAbove = key.rect.top - cellH - 8f
        val popupY = if (popupYAbove < 0f) key.rect.bottom + 8f else popupYAbove
